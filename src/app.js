...
app.get ('/help', (req, res) => {
  res.render ('help', {
    title: 'Develper help',
    para: 'A paragraph (from the Ancient Greek παράγραφος paragraphos, "to write beside" or "written beside") is a self-contained unit of a discourse in writing dealing with a particular point or idea. A paragraph consists of one or more sentences.',
    author: 'Nirdesh',
    name: 'name HELP',
  });
});
